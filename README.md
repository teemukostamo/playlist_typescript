...
## A TypeScript refactor of my [Full Stack Open](https://fullstackopen.com/en/) associated [project](https://github.com/teemukostamo/playlist_javascript)
...
- To start the server in development mode, run `npm run dev` in the project root directory
- To compile the server TypeScript files, run `npm run tsc`
